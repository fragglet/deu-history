...
Bool UseOwnBSP = TRUE; /* user can turn this off if he wishes to use
						  an external BSP program */
...
OptDesc options[] =				/* description of the command line options */
{
    ...
    { "gd", "gamedef",	   OPT_STRING,     "Game to edit",                NULL,                         &Game },
	{ "",   "bsp",         OPT_BOOLEAN,    "Use internal node builder",   "Disable internal node builder", &UseOwnBSP },
