...
void DisplayObjectInfo( int objtype, int objnum) /* SWAP! */
{
   ...
   case OBJ_THINGS:
      ...
      DisplayLevelName( x1, y1, x2, y2, curlev);
      if (objnum < 0)
      {
   ...
   case OBJ_VERTEXES:
      ...
      // Display level name!
      DrawScreenBox3D( x1, y1, x2, y2);
      SetColor( BLUE);
      switch(curlev)
      {
      case 1:
         DrawScreenText( x1 + 5, y1 + 4, "Level 1: Entryway");
         break;
      case 2:
         DrawScreenText( x1 + 5, y1 + 4, "Level 2: Underhalls");
         break;
      case 3:
         DrawScreenText( x1 + 5, y1 + 4, "Level 3: The Gantlet");
         break;
      case 4:
         DrawScreenText( x1 + 5, y1 + 4, "Level 4: The Focus");
         break;
      case 5:
         DrawScreenText( x1 + 5, y1 + 4, "Level 5: The Waste Tunnels");
         break;
      case 6:
         DrawScreenText( x1 + 5, y1 + 4, "Level 6: The Crusher");
         break;
      case 7:
         DrawScreenText( x1 + 5, y1 + 4, "Level 7: Dead Simple");
         break;
      case 8:
         DrawScreenText( x1 + 5, y1 + 4, "Level 8: Tricks and Traps");
         break;
      case 9:
         DrawScreenText( x1 + 5, y1 + 4, "Level 9: The Pit");
         break;
      case 10:
         DrawScreenText( x1 + 5, y1 + 4, "Level 10: Refueling Base");
         break;
      case 11:
         DrawScreenText( x1 + 5, y1 + 4, "Level 11: 'O' of Destruction!");
         break;
      case 12:
         DrawScreenText( x1 + 5, y1 + 4, "Level 12: The Factory");
         break;
      case 13:
         DrawScreenText( x1 + 5, y1 + 4, "Level 13: Downtown");
         break;
      case 14:
         DrawScreenText( x1 + 5, y1 + 4, "Level 14: The Inmost Dens");
         break;
      case 15:
         DrawScreenText( x1 + 5, y1 + 4, "Level 15: Industrial Zone");
         break;
      case 16:
         DrawScreenText( x1 + 5, y1 + 4, "Level 16: Suburbs");
         break;
      case 17:
         DrawScreenText( x1 + 5, y1 + 4, "Level 17: Tenements");
         break;
      case 18:
         DrawScreenText( x1 + 5, y1 + 4, "Level 18: The Courtyard");
         break;
      case 19:
         DrawScreenText( x1 + 5, y1 + 4, "Level 19: The Citadel");
         break;
      case 20:
         DrawScreenText( x1 + 5, y1 + 4, "Level 20: Gotcha!");
         break;
      case 21:
         DrawScreenText( x1 + 5, y1 + 4, "Level 21: Nirvana");
         break;
      case 22:
         DrawScreenText( x1 + 5, y1 + 4, "Level 22: The Catacombs");
         break;
      case 23:
         DrawScreenText( x1 + 5, y1 + 4, "Level 23: Barrels o' Fun");
         break;
      case 24:
         DrawScreenText( x1 + 5, y1 + 4, "Level 24: The Chasm");
         break;
      case 25:
         DrawScreenText( x1 + 5, y1 + 4, "Level 25: Bloodfalls");
         break;
      case 26:
         DrawScreenText( x1 + 5, y1 + 4, "Level 26: The Abandoned Mines");
         break;
      case 27:
         DrawScreenText( x1 + 5, y1 + 4, "Level 27: Monster Condo");
         break;
      case 28:
         DrawScreenText( x1 + 5, y1 + 4, "Level 28: The Spirit World");
         break;
      case 29:
         DrawScreenText( x1 + 5, y1 + 4, "Level 29: The Living End");
         break;
      case 30:
         DrawScreenText( x1 + 5, y1 + 4, "Level 30: Icon of Sin");
         break;
      case 31:
         DrawScreenText( x1 + 5, y1 + 4, "Level 31: Wolfenstein");
         break;
      case 32:
         DrawScreenText( x1 + 5, y1 + 4, "Level 32: Grosse");
         break;
      default:
         DrawScreenText( x1 + 5, y1 + 4, "Level ??: Unknown level!");
         break;
      }
      SetColor( BLACK);
      if (objnum < 0)
...
void DisplayLevelName( int x1, int y1, int x2, int y2, int curlev)
{
   DrawScreenBox3D( x1, y1, x2, y2);
   SetColor( BLUE);
   switch(curlev)
...
void EditObjectsInfo( int x0, int y0, int objtype, SelPtr obj) /* SWAP! */
{
   ...
   case OBJ_THINGS:
      ...
      case 1:
         ...
         case 9:
            val = DisplayThingsMenu( x0 + 84, y0 + 138, "Select Special Item",
                                     THING_TELEPORT,
                                     THING_SPAWNSOURCE,
                                     THING_SPAWNSPOT,
                                     THING_FINALENEMY,
      ...
      case 1:
         ...
         case 2:
            ...
            case 2:
               ...
               break;
            case 3:
               val = DisplayLineDefTypeMenu( x0 + 126, y0 + 122, NULL, /* Turbo Functions */
                                             105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 133, 99, 135, 134, 137, 136, 130, 129, 131, 132,
                                             -1);
               break;
            case 4:
               ...
               break;
            case 5:
               val = DisplayLineDefTypeMenu( x0 + 126, y0 + 122, NULL, /* Floors (raise) */
                                             69, 18, 140, 20, 22, 95, 47, 5, 14, 30, 93, 59, 66, 67, 15, 92, 58, 96, 64, 101, 91, 24, 65, 94, 55, 56, 128, 119,
                                             -1);
               break;
            case 6:
               val = DisplayLineDefTypeMenu( x0 + 126, y0 + 142, NULL, /* Floors (lower) */
                                             45, 60, 102, 82, 83, 19, 38, 70, 71, 98, 36, 23, 84, 68, 37, 9, 21, 85,
                                             -1);
               break;
            case 7:
               val = DisplayLineDefTypeMenu( x0 + 126, y0 + 152, NULL, /* Lifts & Moving things */
                                             62, 88, 10, 77, 6, 73, 74, 57, 87, 53, 89, 54, 7, 8, 100, 127, 120, 121, 122, 123,
                                             -1);
               break;
            case 8:
               val = DisplayLineDefTypeMenu( x0 + 126, y0 + 142, NULL, /* Special */
                                             48, 11, 52, 51, 124, 97, 39, 125, 126, 81, 13, 79, 138, 35, 139, 12, 80, 104, 78, 17,
                                             -1);
               break;
            case 9:
